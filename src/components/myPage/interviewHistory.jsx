...
const rows = [
    { no: 1, thumnail: <PortraitIcon sx={{fontSize: 100}}/>, title: '제목1', date: '2024-01-01', url: '1111' },
    { no: 2, thumnail: <PortraitIcon sx={{fontSize: 100}}/>, title: '제목2', date: '2024-01-01', url: '2222' },
    { no: 3, thumnail: <PortraitIcon sx={{fontSize: 100}}/>, title: '제목3', date: '2024-01-01', url: '3333' }
];
...
const InterviewHistory = () => {
    ...
    return (
        <section className={styles.formContact}>
            <h1 className={styles.formTitle}>모의면접 내역</h1>
