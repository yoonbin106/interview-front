...
import styles from '@/styles/adminPage/adminDeletedPostTable.module.css';
import { Grid } from '@mui/material';

export default function DeletedPostTable({ rows }) {
            ...
            {(rowsPerPage > 0
              ...
              <TableRow key={row.id}>
                ...
                <TableCell align="center">
                  <a href={`/adminPage/adminDeletedPostDetails`} style={{ textDecoration: 'none', color: 'black' }}>
                    {row.title}
                  </a>
                </TableCell>
