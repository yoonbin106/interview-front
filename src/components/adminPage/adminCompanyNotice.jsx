...
import styles from '@/styles/adminPage/adminCompanyNotice.module.css'; // CSS 파일을 import
...
// AdminCompanyNotice 컴포넌트: 공지사항 페이지 전체를 렌더링
const AdminCompanyNotice = () => {
    // 하드코딩된 공지사항 데이터 (임시 데이터)
    const admincompanynotices = [
    ...
    const [filteredNotices, setFilteredNotices] = useState(admincompanynotices); // 필터링된 공지사항 상태
                ...
                <div className={styles.noticeMainContainer}>
                    <div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h2 className={styles.noticeTitle}>기업별 공지사항</h2>
                            <div style={{ display: 'flex', justifyContent: 'flex-end', width: '100%' }}>
                                <RegisterButton to="/adminPage/adminCompanyNoticeRegisterPage" /> {/* 공지사항 등록 버튼 */}
                            </div>
                        </div>
                        {/* 필터링된 공지사항을 테이블로 렌더링 */}
                                    ...
                                    {(rowsPerPage > 0
                                        ...
                                        <TableRow key={row.id}>
                                            ...
                                            <TableCell align="center">
                                                <a href={`/adminPage/adminCompanyNoticeDetailsPage`} className={styles.noticeTableLink}>
                                                    {row.title}
                                                </a>
                                            </TableCell>
