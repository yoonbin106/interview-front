            ...
            <div className={styles.companyNoticeContent}>
                <div className={styles.companyNoticeMainContainer}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <div className={styles.companyNoticeTitleContainer}>
                            <h2 className={styles.companyNoticeTitle}>Company Notices</h2>
                        </div>
                        <hr className={styles.companyNoticeTitleDivider} />
                    </div>
                    <div className={styles.companyNoticeButtonContainer}>
                        <Button
                            variant="contained"
