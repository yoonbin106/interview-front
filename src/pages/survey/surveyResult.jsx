...
const SurveyResult = () => {
  ...
  // const { userName, resultData } = router.query;
          ...
          <div className={styles.surveyCenterFrameHeightResult}>
            ...
            <div className={styles.surveyMainResult}>
              <section className={styles.surveyMainSection}>
                <div className={styles.surveyTitle}>홍길동님의 직업가치관 검사 결과표</div>
                <div className={styles.surveySubTitleLineThank}>홍길동님 수고하셨습니다.</div>
                ...
                <div className={styles.surveyStartButtonFrame}>
                  <a href="#" target="_blank" rel="noopener noreferrer" className={styles.surveyStartButtonResult}>
                    결과보기
                  </a>
                </div>
