...
function ResumeForm() {
  ...
  const confirmAction = () => {
    if (modalContent === '작성한 이력서를 등록하시겠습니까?') {
      // 이력서 데이터를 백엔드로 전송
      const dataToSend = {
        resumeTitle: formData.resume_title,
        schoolName: formData.school_name,
        major: formData.major,
        startDate: formData.start_date,
        endDate: formData.end_date,
        graduationStatus: formData.graduation_status,
        companyName: formData.company_name,
        joinDate: formData.join_date,
        leaveDate: formData.leave_date,
        position: formData.position,
        jobDescription: formData.job_description,
        language: formData.language,
        languageLevel: formData.language_level,
        languageScore: formData.language_score,
        contestName: formData.contest_name,
        contestAward: formData.contest_award,
        contestDate: formData.contest_date,
        certificateName: formData.certificate_name,
        certificateIssuer: formData.certificate_issuer,
        certificateDate: formData.certificate_date,
        portfolioDescription: formData.portfolio_description,
        militaryServiceType: formData.military_service_type,
        militaryStartDate: formData.military_start_date,
        militaryEndDate: formData.military_end_date,
        militaryRank: formData.military_rank,
        desiredSalary: formData.desired_salary,
        desiredStartDate: formData.desired_start_date,
    ...
    <div className={styles.resumeForm}>
      ...
      >
        <ModalContent sx={{ width: 450 }}>
          ...
          <div className={modalStyles.modalButtons}>
            <button onClick={closeModal} className={`${modalStyles.modalCancelButton} ${styles.button}`}>
              취소
            </button>
            <button onClick={confirmAction} className={`${modalStyles.modalConfirmButton} ${styles.button}`}>
              확인
            </button>
          </div>
        </ModalContent>
      ...
      >
        <ModalContent sx={{ width: 450 }}>
          ...
          <div className={modalStyles.modalButtons}>
            <button onClick={navigateToResumeList} className={`${modalStyles.modalConfirmButton} ${styles.button}`}>
              이력서 관리
            </button>
          </div>
        </ModalContent>
      ...
      <div className={styles.formContainer}>
        <form onSubmit={handleSubmit} className={styles.formContainer2}>
          <div className={styles.mb5}>
            <div className={styles.inputWithIcon}>
              ...
              <input 
                ...
                name="resume_title"  // 필드 이름 설정
                value={formData.resume_title}
                onChange={handleChange}  // 기존 handleChange 함수 재사용
              />
            </div>
          </div>
            ...
            <div className={`${styles.formGroup} ${styles.profileImageUpload}`}>
              ...
              <div className={styles.profileImageBox}>
                {profileImage ? (
                  ...
                  <label htmlFor="file-input" className={`${styles.plusButton} ${styles.label}`}>+</label>
                )}
                <input 
                  id="file-input" 
                  type="file" 
            ...
            <div className={styles.personalInfo}>
              <div className={styles.formInline}>
                <div className={styles.formGroup} >
                  <label className={`${styles.required} ${styles.label}`}>이름</label>
                  <input type="text" className={styles.inputText} placeholder="이름" readOnly />
                </div>
                <div className={styles.formGroup} style={{ marginLeft: '15px' }}>
                  <label className={`${styles.required} ${styles.label}`}>생년월일</label>
                  <input type="text" className={styles.inputText} placeholder="생년월일" readOnly />
                </div>
                <div className={styles.formGroup} style={{ marginLeft: '15px'}}>
                  <label className={`${styles.required} ${styles.label}`}>성별</label>
                  <select name="gender" value={formData.gender} onChange={handleChange} className={`${styles.select} ${styles.genderSelect}`}>
              ...
              <div className={styles.formInline}>
                <div className={styles.formGroup} >
                  <label className={`${styles.required} ${styles.label}`}>이메일</label>
                  <input type="email" className={`${styles.emailInput} ${styles.inputEmail}`} placeholder="이메일" readOnly />
                </div>
                <div className={styles.formGroup} >
                  <label className={`${styles.required} ${styles.label}`} >휴대전화번호</label>
                  <input type="text" className={`${styles.inputText} ${styles.phoneNumInput}`} placeholder="휴대전화번호" readOnly />
                </div>
              </div>
            </div>
          </div>
          <div className={styles.formGroup} style={{marginTop:'30px'}}>
            <label className={`${styles.required} ${styles.label}`}>우편번호</label>
            <input type="text" className={`${styles.inputText} ${styles.zipCodeInput}`} placeholder="우편번호" readOnly />
          </div>
          <div className={styles.formInline}>
            <div className={styles.formGroup}>
              <label className={styles.label}>주소</label>
              <input type="text" className={styles.inputText} placeholder="주소" readOnly />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.label}>상세주소</label>
              <input type="text" className={styles.inputText} placeholder="상세주소" readOnly />
            </div>
          </div>
          ...
          <div className={styles.formGroupInlineVertical}>
            <div className={styles.formGroupInline}>
              <div className={styles.formGroup}>
                ...
                <input type="text" className={styles.inputText} placeholder="학교 이름 입력" name="school_name" value={formData.school_name} onChange={handleChange} />
              </div>
              <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
                <label className={styles.label}>전공</label>
                <input type="text" className={styles.inputText} placeholder="전공 입력" name="major" value={formData.major} onChange={handleChange} />
              </div>
            </div>
            <div className={styles.formGroupInline}>
              <div className={styles.formGroup}  >
              ...
              <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
                ...
                <select className={styles.select} name="graduation_status" value={formData.graduation_status} onChange={handleChange}>
                  <option value="">---</option>
          ...
          <button type="button" className={`${styles.add} ${styles.button}`}>+ 학력 추가</button>
          ...
          <div className={styles.formGroupInlineVertical}>
            <div className={styles.formGroupInline}>
              <div className={styles.formGroup}>
                ...
                <input type="text" className={styles.inputText} placeholder="회사 이름 입력" name="company_name" value={formData.company_name} onChange={handleChange} />
              </div>
              <div className={styles.formGroup} style={{ width: '200px' , marginLeft:'30px' }}>
                <label className={styles.label}>입사</label>
                <div className={styles.datePickerContainer}>
                  <DatePickerInput placeholder="----년 --월 --일" name="join_date" value={formData.join_date} onChange={handleChange} />
                </div>
              </div>
              <div className={styles.formGroup} style={{ width: '200px' , marginLeft:'30px' }}>
                <label className={styles.label}>퇴사</label>
                <div className={styles.datePickerContainer}>
            ...
            <div className={styles.formGroupInline}>
              <div className={styles.formGroup}>
                ...
                <input type="text" className={styles.inputText} placeholder="직위/직책 입력" name="position" value={formData.position} onChange={handleChange} />
              </div>
              <div className={styles.formGroup} style={{marginLeft:'30px'}}>
                <label className={styles.label}>업무내용</label>
                <input type="text" className={styles.inputText} placeholder="업무내용 입력" name="job_description" value={formData.job_description} onChange={handleChange} />
              </div>
            </div>
          </div>
          <button type="button" className={`${styles.add} ${styles.button}`}>+ 경력 추가</button>
          ...
          <div className={styles.formGroupInline}>
            <div className={styles.formGroup} >
              ...
              <input type="text" className={styles.inputText} placeholder="외국어 입력" name="language" value={formData.language} onChange={handleChange} />
            </div>
            <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
              <label className={styles.label}>평가등급</label>
              <input type="text" className={styles.inputText} placeholder="평가등급 입력" name="language_level" value={formData.language_level} onChange={handleChange} />
            </div>
            <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
              <label className={styles.label}>시험점수</label>
              <input type="text" className={styles.inputText} placeholder="시험점수 입력" name="language_score" value={formData.language_score} onChange={handleChange} />
            </div>
          </div>
          <button type="button" className={`${styles.add} ${styles.button}`}>+ 외국어 추가</button>
          ...
          <div className={styles.formGroupInline}>
            <div className={styles.formGroup}>
              ...
              <input type="text" className={styles.inputText} placeholder="대회명 입력" name="contest_name" value={formData.contest_name} onChange={handleChange} />
            </div>
            <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
              <label className={styles.label}>입상내역</label>
              <input type="text" className={styles.inputText} placeholder="입상내역 입력" name="contest_award" value={formData.contest_award} onChange={handleChange} />
            </div>
            <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
              <label className={styles.label}>수상일</label>
              <DatePickerInput placeholder="----년 --월 --일" name="contest_date" value={formData.contest_date} onChange={handleChange} />
            </div>
          </div>
          <button type="button" className={`${styles.add} ${styles.button}`}>+ 입상경력 추가</button>
          ...
          <div className={styles.formGroupInline}>
            <div className={styles.formGroup} >
              ...
              <input type="text" className={styles.inputText} placeholder="자격증명 입력" name="certificate_name" value={formData.certificate_name} onChange={handleChange} />
            </div>
            <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
              <label className={styles.label}>발급기관</label>
              <input type="text" className={styles.inputText} placeholder="발급기관 입력" name="certificate_issuer" value={formData.certificate_issuer} onChange={handleChange} />
            </div>
            <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
              <label className={styles.label}>취득일</label>
              <DatePickerInput placeholder="----년 --월 --일" name="certificate_date" value={formData.certificate_date} onChange={handleChange} />
            </div>
          </div>
          <button type="button" className={`${styles.add} ${styles.button}`}>+ 자격증 추가</button>
          ...
          <div className={styles.formGroupInline}>
            ...
            <div className={styles.formGroup}>
              ...
              <input type="text" className={styles.inputText} placeholder="포트폴리오 설명 입력" name="portfolio_description" value={formData.portfolio_description} onChange={handleChange} />
            </div>
          </div>
          <button type="button" className={`${styles.add} ${styles.button}`}>+ 포트폴리오 추가</button>
          ...
          <div className={`${styles.formGroupInline} ${styles.alignItemsCenter}`}>
            <div className={styles.formGroup}>
              ...
              <select className={styles.select} name="military_service_type" value={formData.military_service_type} onChange={handleChange}>
                <option value="">선택하세요</option>
            ...
            <div className={styles.formGroup} style={{ marginLeft: '30px' , width:'130px' }}>
              ...
              <input type="text" className={styles.inputText} placeholder="계급 입력" name="military_rank" value={formData.military_rank} onChange={handleChange} />
            </div>
          </div>
          ...
          <div className={styles.formGroupInline}>
            <div className={styles.formGroup}>
              ...
              <input type="text" className={styles.inputText} placeholder="희망 연봉 입력 (원)" name="desired_salary" value={formData.desired_salary} onChange={handleChange} />
            </div>
            <div className={styles.formGroup} style={{ marginLeft: '30px' }}>
              <label className={styles.label}>희망 입사일</label>
