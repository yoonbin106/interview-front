...
import ReportedPostTable from '@/components/adminPage/adminReportedPostTable';
import styles from '@/styles/adminPage/adminPage.module.css';
import NestedList from '@/components/adminPage/adminSideMenu';

const reportedPosts = [
    { id: 3021, category: '광고', title: '단 6개월만에 취업성공? ICT2기 절찬리에 모집중_링크클릭', author: 'user789', date: '2023-08-10', content: '여기에 게시글 내용이 들어갑니다.' },
    ...
    { id: 3024, category: '비방', title: 'ewns__이사람 조심하세요 미쳐있음', author: 'user456', date: '2023-08-07', content: '여기에 게시글 내용이 들어갑니다.' },
    ...
    { id: 3029, category: '광고', title: '추피티vs흥파고 리벤지대결!!!!', author: 'user456', date: '2023-08-02', content: '여기에 게시글 내용이 들어갑니다.' },
...
export default function AdminReportPostPage() {
    ...
    const rows = reportedPosts.map(post => ({
        ...
        author: post.author,
        date: post.date,
        onClick: () => router.push(`/adminPage/adminReportedPostDetailsPage`), // 특정 ID 없이 고정된 경로로 이동
    }));
